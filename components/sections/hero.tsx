                  ...
                  <div className="grid gap-4 p-5 sm:p-6">
                    ...
                    <div className="relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-gradient-to-br from-electric/25 via-transparent to-cyan/25 p-3">
                      ...
                      <div className="relative overflow-hidden rounded-[1.25rem] border border-white/10 bg-[#040814]/90">
                        <div className="mx-auto w-full max-w-[320px] pt-2">
                          <video
                            ref={videoRef}
                            className="aspect-[9/16] h-[420px] w-full object-cover object-center sm:h-[500px]"
                        ...
                        <div className="absolute inset-x-0 bottom-0 flex justify-end bg-gradient-to-t from-[#020611] via-[#020611]/75 to-transparent p-4">
                          <button
                            type="button"
                            onClick={toggleSound}
                            className="rounded-full border border-cyan/30 bg-cyan/15 px-4 py-2 text-sm font-semibold text-cyan transition hover:border-cyan/50 hover:bg-cyan/20"
                          >
                    ...
                    <div className="grid gap-3 sm:grid-cols-3">
                      {["YouTube", "Reels", "Cinematic"].map((item) => (
                        <div
                          key={item}
                          className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-slate-300 transition duration-300 hover:border-cyan/30 hover:text-white"
                        >
                          {item}
                        </div>
                      ))}
